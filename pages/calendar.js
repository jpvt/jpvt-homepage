  ...
  <Layout title="Calendar">
    <Container maxW="container.md" py={10}>
      <Section>
        ...
        <Text mb={4}>
        I allocated some time 1:1 slots for anyone interested in discussing career paths, research projects,
        ...
        <Box overflow="hidden" borderRadius="md" mb={6}>
          ...
          <iframe
            src="https://calendar.google.com/calendar/embed?src=jpvteixeira99%40gmail.com&ctz=America%2FVancouver"
            style={{ border: 0 }}
            width="100%"
            height="600"
            frameBorder="0"
