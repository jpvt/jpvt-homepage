import { Container, Heading, Text, Box, Link, Button } from '@chakra-ui/react'
  ...
  <Layout title="Calendar">
    <Container maxW="container.md" py={10}>
      <Section>
        ...
        <Text mb={4}>
          I allocated some 1:1 time slots for anyone interested in discussing
          career paths, research projects, or simply connecting over a virtual
          coffee chat. Feel free to book a slot that works for you :)
        </Text>
